...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Time Logs for User</h1>
        
        <div class="bg-gray-50 rounded-lg p-4 mt-4">
            <p class="text-sm text-gray-600"><strong>User:</strong> {{ $user->name }}</p>
            <p class="text-sm text-gray-600 mt-2"><strong>Email:</strong> {{ $user->email }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm">Projects Involved</p>
                    <p class="text-3xl font-bold text-gray-800">{{ $stats['projects_involved'] }}</p>
                </div>
