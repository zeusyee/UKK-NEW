        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 mb-4">
            <div class="flex-1">
                ...
                <div class="mt-4 flex gap-2">
                    <a href="{{ route('group-chat.room', $project->project_id) }}" class="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white text-sm font-semibold rounded-lg transition-colors">
                        <i class="fas fa-comments mr-2"></i>Open Group Chat
                    </a>
                </div>
