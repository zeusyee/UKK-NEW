...
class SubtaskController extends Controller
{
    ...
    /**
     * Store a new subtask (Leader only)
     */
    public function storeLeader(Request $request, Project $project, Board $board, Card $card)
    {
    ...
    /**
     * Start a subtask (Leader only)
     */
    public function startSubtaskLeader(Request $request, Project $project, Board $board, Card $card, Subtask $subtask)
    {
        $this->checkLeaderAccess($project->project_id);
    ...
    /**
     * Submit subtask for review (Leader only)
     */
    public function submitSubtaskLeader(Request $request, Project $project, Board $board, Card $card, Subtask $subtask)
    {
        $this->checkLeaderAccess($project->project_id);
